...
public class RocketMQProducer {
    ...
    public void send(Object object,String topic) {
        rocketMQTemplate.send(topic , MessageBuilder.withPayload(object).build());
    }
    /**
     ...
     * @return
     */
    public SendResult sendDelayMsg(String msgBody, int delayLevel,String topic) {
     ...
     */
    public SendResult sendTagMsg(String msgBody,String topic) {
